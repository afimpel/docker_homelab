    ...
    <div class="container-fluid py-1" id="active_<?php echo strtolower(getenv('COMPOSE_PROJECT_NAME')); ?>_local">
        <div class="row mx-1 mt-1 mb-4">
            ...
            <div class="col-12 col-xl-5">
                ...
                <div class="mt-3 list-group shadow">
                    <a name="php5_<?php echo strtolower(getenv('COMPOSE_PROJECT_NAME')); ?>_local_tooltip" data-bs-toggle="tooltip" data-bs-placement="left" target="_blank" class="list-group-item list-group-item-info list-group-item-action p-1 px-2 d-flex" href="//php5.<?php echo strtolower(getenv('COMPOSE_PROJECT_NAME')); ?>.local/"><i class="icon-php-alt mx-2"></i> PHP5 ➤ phpinfo()<small style="font-size: small;" class="badge text-light bg-primary rounded ms-auto my-auto" name="php5_<?php echo strtolower(getenv('COMPOSE_PROJECT_NAME')); ?>_local">-</small></a>
    ...
    <div class="container-fluid py-1" id="active2_<?php echo strtolower(getenv('COMPOSE_PROJECT_NAME')); ?>_local">
        <div class="container border border-primary rounded p-2 my-1 shadow">
            ...
            <ol>
                ...
                <li>
                    <ul>
                        <li>for <b class="ms-1">PHP5</b>, type this command: <code class="mx-2" style="font-size: larger;">docker exec -it homelab-php5 bash</code> or <code class="mx-2" style="font-size: larger;"><?php echo strtolower(getenv('COMPOSE_PROJECT_NAME')); ?> php5 --user</code></li>
