<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExtraInfo" aria-labelledby="offcanvasExtraInfoLabel">
    ...
    <div class="container p-2 mb-4">
        <p class="d-flex">Theme used in the dashboard:<a class="ms-auto text-decoration-none" href="//bootswatch.com/spacelab/" target="_blank"><i class="bi bi-bootstrap-fill mx-2"></i>Spacelab</a></p>
